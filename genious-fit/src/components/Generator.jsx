    ...
    return (
        <SectionWrapper header={"generate your workout"}
            ...
            <Header index={'02'} title={'Lock on targets'}
                description={"Select the muscle judget for anhilation."} />
            <div className='bg-slate-950 border border-solid-400 rounded-lg flex flex-col'>
            ...
            <div className='grid grid-cols-3 gap-4'>
                {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
                    return (
                        <button key={schemeIndex} className='bg-slate-950 border border-blue-400
                        duration-200 hover:border-blue-600 py-3 rounded-lg'>
